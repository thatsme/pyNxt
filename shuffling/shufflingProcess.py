...
class ShufflingProcess(Parent):
    def __init__(self, shuffling=None, recipientSecretPhrase = None, recipientPublicKey=None,  publicKey = None, secretPhrase=None, feeNQT = None, deadline = 0, referencedTransactionFullHash = None, broadcast=True, phasing = None, message=None ):
        """
        ...
        super(ShufflingProcess, self).__init__(rt="shufflingProcess", data=self.data, phasing=self.phasing, message=self.message)
