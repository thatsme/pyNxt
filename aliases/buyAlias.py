...
class BuyAlias(Parent):
    def __init__(self, alias = None, aliasName=None, amountNQT=0, secretPhrase=None,  publicKey = None, feeNQT = None, deadline = 0, referencedTransactionFullHash = None, broadcast=False, phasing = None, message=None, recipientPublicKey=None, rec=None ):
        """
            Buy or sell an alias

            BuyAlias take a default 5 parameter as explained in NXT API Documentation
            ...
            :param amountNQT : is the amount (in NQT) offered for an alias for sale (buyAlias only) (N)
        ...
        super(BuyAlias, self).__init__(rt="buyAlias", data=self.data, phasing=self.phasing, message=self.message, rec=self.rec)
