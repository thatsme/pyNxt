...
class GetExpectedBuyOffers(Parent):
    def __init__(self, currency=None, account=None, availableOny=False, sortByRate=False,  requireBlock=None, requireLastBlock=None ):
        """
            ...
            GetExpectedBuyOffers take a default 1/2 parameter as explained in NXT API Documentation

            Class is working with GET method

            https://nxtwiki.org/wiki/The_Nxt_API#Get_Expected_Buy_Offers
        ...
        super(GetExpectedBuyOffers, self).__init__(rt="getExpectedBuyOffers", data=self.data)
    ...
    def getData(self, key=None):
        ...
        """
        return super(GetExpectedBuyOffers, self).getData(key)                           # calls 'BaseGet.getData()'
