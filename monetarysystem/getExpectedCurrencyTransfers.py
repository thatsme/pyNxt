...
class GetExpectedCurrencyTransfers(Parent):
    def __init__(self, currency=None, account = None, timestamp=None, includeCurrencyInfo=False, firstIndex=None, lastIndex=None, requireBlock=None, requireLastBlock=None ):
        """
            ...
            GetExpectedCurrencyTransfers take a default 1/5 parameter as explained in NXT API Documentation

            Class is working with GET method

            https://nxtwiki.org/wiki/The_Nxt_API#Get_Expected_Currency_Transfers
        ...
        super(GetExpectedCurrencyTransfers, self).__init__(rt="getExpectedCurrencyTransfers", data=self.data)
    ...
    def getData(self, key=None):
        ...
        """
        return super(GetExpectedCurrencyTransfers, self).getData(key)                           # calls 'BaseGet.getData()'
