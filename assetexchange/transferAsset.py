...
class TransferAsset(Parent):
    def __init__(self, recipient=None, asset = None, quantityQNT=0, secretPhrase=None,  publicKey = None, feeNQT = None, deadline = 0, referencedTransactionFullHash = None, broadcast=False, phasing = None, message=None ):
        """
            ...
            asset : is the asset ID of the asset being transferred
        ...
        super(TransferAsset, self).__init__(rt="transferAsset", data=self.data, phasing=self.phasing, message=self.message)
