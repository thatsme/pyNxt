...
class GetAssetPhasedTransactions(Parent):
    def __init__(self, asset=None, account=None, firstIndex=None, lastIndex=None, withoutWitelist=False, requireBlock=None, requireLastBlock=None ):
        """
        ...
        super(GetAssetPhasedTransactions, self).__init__(rt="getAssetPhasedTransactions", data=self.data)
