...
class DgsRefund(Parent):
    def __init__(self, purchase=None, refundNQT=0, secretPhrase=None,
        ...
        """
            ...
            refundNQT : is the amount (in NQT) of the refund (N)
        ...
        super(DgsRefund, self).__init__(rt="dgsRefund", data=self.data, phasing=self.phasing, message=self.message)
