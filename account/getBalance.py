...
class GetBalance(Parent):
    ...
    def __init__(self, account=None, includeEffectiveBalance=False, height= None, requireBlock=None, requireLastBlock=None ):
        """
            ...
            height : is the height to retrieve account balance for, if still available (N) (O)
            ...
            effectiveBalanceNXT : is the balance (in NXT) of the account available for forging: the unleased guaranteedBalance
                                of this account plus the leased guaranteedBalance of all lessors to this account (N)
