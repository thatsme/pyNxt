...
class AddPeer(Parent):
    def __init__(self, peer=None):
        """
            Add a peer to the list of known peers and attempt to connect to it.
            Password protected like the Debug Operations.
            POST only.

            AddPeer take a default 1 parameter as explained in NXT API Documentation

            https://nxtwiki.org/wiki/The_Nxt_API#Add_Peer
    ...
    def getData(self, key=None):
        ...
        """
        return super(AddPeer, self).getData(key)  # calls 'BasePost.getData()'
