...
class GetAccountPhasedTransactions(Parent):
    ...
    def __init__(self, account=None, firstIndex=None, lastIndex=None, requireBlock=None, requireLastBlock=None):
        """
            ...
            RESPONSE
            sender : is the accounts ID of the sender (S)
            ...
            senderPublicKey : is the public key of the sending accounts for the transaction (S)
            ...
            recipient : is the accounts number of the recipient, if applicable (S)
