...
class GetAccountProperties(Parent):
    ...
    def __init__(self, recipient=None, setter=None, property=None, firstIndex=None, lastIndex=None, requireBlock=None, requireLastBlock=None):
        """
            ...
            REQUEST
            recipient : is the accounts ID to which the property is attached to (S)
            setter : is the accounts ID who set the property (S) (optional if recipient provided)
            ...
            RESPONSE
            setterRS: is the Reed-Solomon address of the setter accounts (S) (only if setter is defined in the request)
            recipientRS: is the Reed-Solomon address of the recipient accounts (S) (only if recipient is defined in the request)
            recipient: is the accounts number of the recipient accounts (S) (only if recipient is defined in the request)
            requestProcessingTime : is the API request processing time (in millisec) (N)
            setter: is the accounts number of the setter accounts (S) (only if setter is defined in the request)
