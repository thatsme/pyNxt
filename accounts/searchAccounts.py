...
class SearchAccounts(Parent):
    ...
    def __init__(self, query=None, firstIndex=None, lastIndex=None, requireBlock=None, requireLastBlock=None ):
        """
            ...
            REQUEST
            query : is a full text query on the accounts fields name (S) and description (S) in the standard Lucene syntax
            ...
            RESPONSE
            accounts (A) is an array of accounts objects with the following fields:
