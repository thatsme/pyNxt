...
class GetAccountCurrentBidOrders(Parent):
    ...
    def __init__(self, account=None, assets=None, ri=None, rb=None):
        """
            GetAccountCurrentBidOrders take a default 1 parameter as explained in NXT API Documentation

            API is working with GET method

            https://nxtwiki.org/wiki/The_Nxt_API#Get_Account_Current_Bid_Orders
        ...
        super(GetAccountCurrentBidOrders, self).__init__(rt = "getAccountCurrentBidOrders", data=self.data, ri=self.ri, rb=self.rb)
